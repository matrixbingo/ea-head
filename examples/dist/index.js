				...
				var Head = (function (_Component) {
					...
					Head.prototype.renderMainNav = function renderMainNav(titles) {
						var mainNav = titles.map(function (item) {
							return _react2['default'].createElement('a', { className: 'nav-link', href: item.href }, item.title);
						});
					...
					Head.prototype.render = function render() {
						...
						return _react2['default'].createElement('div', null, _react2['default'].createElement('div', { className: 'head-inner' }, _react2['default'].createElement('div', { className: 'outer' }, _react2['default'].createElement('a', { className: 'logo-link' }, _react2['default'].createElement('i', { className: 'logo' }), _react2['default'].createElement('span', { className: 'team-title' }, 'FutureTeam')), content)), this.getMobileNav(content));
					};
