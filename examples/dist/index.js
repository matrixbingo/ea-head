...
/***/ (function(module, exports, __webpack_require__) {
	...
	var titles = [{ title: '博客111', href: 'http://uedfamily.com/' }, { title: '文档', href: 'http://www.baidu.com' }, { title: '关于我们', href: 'http://uedfamily.com/about/' }, { title: '更多组件', href: 'http://uedfamily.com/framework/' }];
	
	_reactLibReactDOM2['default'].render(_react2['default'].createElement(_distEaHeadJs.Head, { logo: logo, titles: titles }), document.getElementById('head'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	})(undefined, function (__WEBPACK_EXTERNAL_MODULE_7__) {
				...
				var Head = (function (_Component) {
					...
					Head.prototype.renderMainNav = function renderMainNav(titles) {
						...
						var mainNav = titles.map(function (item) {
							return _react2['default'].createElement('a', { key: ++i, className: 'nav-link', href: item.href }, item.title);
						});
						return _react2['default'].createElement('div', { className: 'main-nav' }, mainNav);
					};
					...
					Head.prototype.getMobileNav = function getMobileNav(content) {
						return _react2['default'].createElement('div', { className: 'sub-inner' }, content);
					};
					...
					Head.prototype.render = function render() {
						...
						return _react2['default'].createElement('div', null, _react2['default'].createElement('div', { className: 'head-inner' }, _react2['default'].createElement('div', { className: 'outer' }, _react2['default'].createElement('a', { className: 'logo-link' }, _react2['default'].createElement('i', { className: logo.className }), _react2['default'].createElement('span', { className: 'team-title' }, logo.title)), content)), this.getMobileNav(content));
					};
			...
			function (module, exports, __webpack_require__) {
				...
				var Footer = (function (_Component) {
					...
					Footer.prototype.render = function render() {
						...
						return _react2['default'].createElement('div', { className: 'footer-inner' }, this.getContent());
					};
